    ...
    public void run(String... args) {
        ...
        List<Place> places = List.of(
            ...
            Place.builder()
                ...
                .imageUrl("https://images.unsplash.com/photo-1609357605129-4f208c25b97c?w=800")
                .bestTimeToVisit("October to March")
                .entryFee("Free")
                .timings("5:00 AM - 9:00 PM")
            ...
            Place.builder()
                ...
                .imageUrl("https://images.unsplash.com/photo-1591019479261-1a103585c559?w=800")
                .bestTimeToVisit("October to February")
            ...
            Place.builder()
                ...
                .imageUrl("https://images.unsplash.com/photo-1585166059782-f28143545183?w=800")
                .bestTimeToVisit("October to February")
                .entryFee("₹20 per person")
                .timings("9:00 AM - 5:00 PM")
